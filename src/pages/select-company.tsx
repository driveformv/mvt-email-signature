...
const SelectCompanyPage = () => {
  const companies = [
    ...
    { id: 'BORDER_INTERNATIONAL', href: '/border-international', name: 'Border International' },
    // { id: 'STAGECOACH', href: '/stagecoach', name: 'Stagecoach' },
  ];

  const [selectedCompany, setSelectedCompany] = useState<
    'MESILLA_VALLEY_TRANSPORTATION' | 'BORDER_TIRE' | 'BORDER_INTERNATIONAL' | 'STAGECOACH'
  >('MESILLA_VALLEY_TRANSPORTATION');

  const navigate = useNavigate();

  const handleClick = () => {
    const selected = companies.find((company) => company.id === selectedCompany);
      ...
      <div className={styles.layout}>
        <div className={styles.sidePanel}>
          ...
          <SelectInput
            ...
            onChange={(e) =>
              setSelectedCompany(e.currentTarget.value as 'MESILLA_VALLEY_TRANSPORTATION' | 'BORDER_TIRE')
            }
          />
        ...
        <div className={styles.mainPanel}>
          <CompaniesProvider company={selectedCompany || 'MESILLA_VALLEY_TRANSPORTATION'}>
